    ...
    public partial class App : PrismApplication
    {
        ...
        protected override void RegisterTypes(IContainerRegistry containerRegistry)
        {
            try
            {
                ...
                containerRegistry.RegisterForNavigation<LearnTabQuranQuestionSelectionPage, LearnTabQuranQuestionSelectionPageViewModel>();
                containerRegistry.RegisterForNavigation<LearTabFlipWebViewPage, LearTabFlipWebViewPageViewModel>();
                containerRegistry.RegisterForNavigation<LearnTabFlipQuranPage, LearnTabFlipPageQuranViewModel>();
