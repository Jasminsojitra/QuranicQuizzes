...
namespace QuranicQuizzes.Interfaces
{
    public interface IClientAPI
    {
        ...
        Task<Chapters> GetChapter();
        Task<FlashCard> GetFlashCards(int id, int categoryID, bool qShuffle, bool removeDuplicates, int startVerse, int endVerse, string language);
        Task<LearnQuranRespo> GetQuranFlashCards(int id, int categoryID, bool qShuffle, bool removeDuplicates, bool switchOrder, int startVerse, int endVerse, string language);

        Task<bool> ResetFlashCardProgress(int id, int categoryID);
        Task<bool> SaveFlashCardProgress(int id, int categoryID,int questionId);
    }
}
