...
{
    public partial class LearnTabFlipQuranPage : ContentPage
    {
        private LearnTabFlipPageQuranViewModel vm;

        public LearnTabFlipQuranPage()
        {
            InitializeComponent();
            vm = (LearnTabFlipPageQuranViewModel)BindingContext;
        }
