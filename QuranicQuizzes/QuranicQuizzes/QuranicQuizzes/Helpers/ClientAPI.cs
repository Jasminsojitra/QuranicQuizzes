...
namespace QuranicQuizzes.Helpers
{
    ...
    public class ClientAPI: IClientAPI
    {
       //Login
        ...
        public async Task<Chapters> GetChapter()
        {
            Chapters _chapters = new Chapters();
            var requestUrl = GlobalConst.ApiUrl + "api/FlashCard/Chapters?" + GlobalConst.ApiUrlKey;
            HttpClient client = new HttpClient();
            ...
            try
            {
                ...
                if (statusCode == 200)
                {
                    ...
                    var responseData = await result.Content.ReadAsStringAsync().ConfigureAwait(false);
                    _chapters = JsonConvert.DeserializeObject<Chapters>(responseData);
                    return _chapters;
        ...
        public async Task<FlashCard> GetFlashCards(int id, int categoryID, bool qShuffle, bool removeDuplicates, int startVerse, int endVerse, string language)
        {
            FlashCard _flashCardQuestions = new FlashCard();
            var requestUrl = GlobalConst.ApiUrl + "api/FlashCard/" + id+"/"+categoryID + "?" + GlobalConst.ApiUrlKey + "&shuffle=" + qShuffle + "&duplicates=" + removeDuplicates ;
            ...
            try
            {
                ...
                {
                    var responseData = await result.Content.ReadAsStringAsync().ConfigureAwait(false);
                    _flashCardQuestions = JsonConvert.DeserializeObject<FlashCard>(responseData);
        ...
        public async Task<bool> ResetFlashCardProgress(int id, int categoryID)
        {
            try
            {
                var requestUrl = GlobalConst.ApiUrl + "api/FlashCard/ResetProgress/"+id+"/"+categoryID+"?" + GlobalConst.ApiUrlKey;
        ...
        public async Task<bool> SaveFlashCardProgress(int id, int categoryID, int questionId)
        {
            try
            {
                var requestUrl = GlobalConst.ApiUrl + "api/FlashCard/Progress/" + id + "/" + categoryID+"/"+questionId + "?" + GlobalConst.ApiUrlKey;
        ...
        public async Task<LearnQuranRespo> GetQuranFlashCards(int id, int categoryID, bool qShuffle, bool removeDuplicates,bool order, int startVerse, int endVerse, string language)
        {
            LearnQuranRespo _flashCardQuestions = new LearnQuranRespo();
            var requestUrl = GlobalConst.ApiUrl + "api/FlashCard/" + id + "/" + categoryID + "?" + GlobalConst.ApiUrlKey + "&shuffle=" + qShuffle + "&duplicates=" + removeDuplicates+ "&order="+order + "&startVerse="+startVerse + "&endVerse="+endVerse +"&language="+ language;
            ...
            try
            {
                ...
                {
                    var responseData = await result.Content.ReadAsStringAsync().ConfigureAwait(false);
                    _flashCardQuestions = JsonConvert.DeserializeObject<LearnQuranRespo>(responseData);
                    return _flashCardQuestions;
